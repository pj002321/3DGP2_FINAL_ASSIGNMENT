...
class CUseWaterMoveTerrain : public CGameObject
{
public:
	CUseWaterMoveTerrain(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, LPCTSTR pFileName, int nWidth, int nLength, int nBlockWidth, int nBlockLength, XMFLOAT3 xmf3Scale, XMFLOAT3 xmf3Normal);
	virtual ~CUseWaterMoveTerrain();
...
public:
	...
	virtual void OnPreRender(ID3D12GraphicsCommandList* pd3dCommandList, CScene* pScene,CCamera* pCamera);
