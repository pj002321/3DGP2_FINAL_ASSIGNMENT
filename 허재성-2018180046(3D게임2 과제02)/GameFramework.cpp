...
CGameFramework::CGameFramework()
{
	...
	m_pScene = NULL;
	m_pPlayer = NULL;
	m_GameSound.backGroundMusic();
	m_GameSound.SpeakMusic();
...
void CGameFramework::BuildObjects()
{
	...
	m_pPlayer = new CMainPlayer(m_pd3dDevice, m_pd3dCommandList, m_pScene->GetGraphicsRootSignature());
	m_pCamera = m_pPlayer->GetCamera();
	m_pPlayer->SetPosition(XMFLOAT3(1200.0, 900.0, 1200.0));
